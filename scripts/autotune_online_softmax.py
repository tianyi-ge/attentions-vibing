...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--block-qm", default="16,32,64", help="Comma-separated BLOCK_QM candidates.")
    parser.add_argument("--block-kn", default="16,32,64", help="Comma-separated BLOCK_KN candidates.")
    parser.add_argument("--num-warps", default="4,8", help="Comma-separated num_warps candidates.")
    parser.add_argument("--num-stages", default="3,4", help="Comma-separated num_stages candidates.")
